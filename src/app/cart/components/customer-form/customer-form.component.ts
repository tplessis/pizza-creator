...
export class CustomerFormComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    email: [this.cartService.user?.email, [Validators.required, Validators.email]],
    phone: [this.cartService.user?.phone, [Validators.required, Validators.pattern(/^(?:(?:\+|00)33|0)\s*[1-9](?:[\s.-]*\d{2}){4}$/gmi)]],
